...
boundary_widths = 100
n_o, boundary_array = add_absorbing_boundaries(n.numpy(), boundary_widths)
assert n_o.imag.min() >= 0, "Imaginary part of n_o is negative"

domain_o = Helmholtz(permittivity=n_o, periodic=periodic, wavelength=wavelength, pixel_size=pixel_size, debug=True)
...
kwargs0 = dict(
    ...
    ha="center",
    va="center",
    bbox=dict(facecolor="white", edgecolor="black", boxstyle="round,pad=0.1", alpha=0.5, linewidth=0.0),
)

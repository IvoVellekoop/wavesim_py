...
def test_compare_a(n_size, boundary_widths):
    ...
    base_w = HelmholtzBase(refractive_index=n, source=source, boundary_widths=boundary_widths,
    ...
    base_o = HelmholtzBase(refractive_index=n, source=source, boundary_widths=boundary_widths,
